...
# gfx942 (MI300/MI325) uses AMD FNUZ FP8.
# gfx950 (MI350) and gfx1151 (RDNA 4 / Radeon RX 9000 series) use OCP E4M3 FP8.
fp8_macro = (
...
# - gfx1151 (RDNA 4 iGPU): LDS is 64KB per workgroup -> keep dynamic smem <= ~48KB.
